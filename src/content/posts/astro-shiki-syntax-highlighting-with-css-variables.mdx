...
cover: ../../assets/covers/1.webp
---

By default, Astro uses [Shiki][shiki] for syntax highlighting markdown code blocks. Astro comes with
an array of Shiki themes by default. However, let's learn how to make our own using _CSS Variables_.
...
Within Astro's [source code][astro-remark-shiki], there's a _remark-shiki integration_ that defines
a set of CSS Variables. Taking note of these variables, we can now override them with our own:
